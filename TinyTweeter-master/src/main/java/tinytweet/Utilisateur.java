...
public class Utilisateur {
	...
	public void removeTweet(Long tweetID) {
		this.mytweets.remove(tweetID);
	}
	
	public void addAbonnement(Long userID) {
		this.abonements.add(userID);
	}
	
	public void removeAbonnement(Long userID) {
		this.abonements.remove(userID);
	}
